...
// Skills placeholder — returns static description since ClawForge uses Claude Code tools
function loadSkillDescriptions() {
  return 'Claude Code CLI with Read, Write, Edit, Bash, Glob, Grep, WebFetch, WebSearch tools.';
}
