...
- [ ] **Phase 9: Config Layer + Tool Schema + Entrypoint Foundation** - Thread target_repo from agent input through job creation and establish entrypoint correctness blockers
